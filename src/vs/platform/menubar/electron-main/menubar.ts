...
export class Menubar {
	...
	private setMacApplicationMenu(macApplicationMenu: Menu): void {
		...
		const confirmQuit = this.createMenuItem(nls.localize('miConfirmBeforeQuit', "Confirm Before Quitting"), 'workbench.action.toggleConfirmBeforeQuit', this.windowsMainService.getWindowCount() > 0, this.configurationService.getValue<boolean>('workbench.confirmBeforeQuit'));
