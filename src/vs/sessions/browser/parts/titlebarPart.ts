...
import { chatPanelTitleBackground, chatPanelTitleForeground } from '../../common/theme.js';
...
export class TitlebarPart extends Part implements ITitlebarPart {
	...
	override updateStyles(): void {
		...
		if (this.element) {
			...
			const titleBackground = this.getColor(chatPanelTitleBackground, (color, theme) => {
			...
			const titleForeground = this.getColor(chatPanelTitleForeground);
